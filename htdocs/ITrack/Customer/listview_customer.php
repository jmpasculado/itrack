...
$html = new customer_html;
$html->draw_header('List View: customer', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add customer')) echo "&nbsp; &nbsp; <a href='add_customer.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View customer')) echo "&nbsp; &nbsp; <a href='csv_customer.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_customer.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit customer')) echo "&nbsp;&nbsp;<a href='edit_customer.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete customer')) echo "&nbsp;&nbsp;<a href='delete_customer.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
