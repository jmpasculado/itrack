...
require_once 'subclasses/salesinvoice_html.php';
$html = new salesinvoice_html;
...
require_once 'subclasses/salesinvoice.php';
$data_con = new salesinvoice;
...
$html = new salesinvoice_html;
$html->draw_header('List View: salesinvoice', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add salesinvoice')) echo "&nbsp; &nbsp; <a href='add_salesinvoice.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View salesinvoice')) echo "&nbsp; &nbsp; <a href='csv_salesinvoice.php'> </a>";
	if(check_link('View salesinvoice')) echo "&nbsp; &nbsp; <a href='http://localhost/Project1'> View Report </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_salesinvoice.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit salesinvoice')) echo "&nbsp;&nbsp;<a href='edit_salesinvoice.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete salesinvoice')) echo "&nbsp;&nbsp;<a href='delete_salesinvoice.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
