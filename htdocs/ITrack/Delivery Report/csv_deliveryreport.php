...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_deliveryreport_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_deliveryreport->export_to_csv();
...
$html->draw_header('CSV Exporter: deliveryreport', $message, $message_type);
...
$html->draw_text_field('Authorized Person', 'AuthPerson', FALSE, 'text', TRUE);
$html->draw_text_field('Status', 'Status', FALSE, 'text', TRUE);
$html->draw_text_field('Remarks', 'Remarks', FALSE, 'text', TRUE);
$html->draw_text_field('Purchaseorder', 'Purchaseorder_id', FALSE, 'text', TRUE);
