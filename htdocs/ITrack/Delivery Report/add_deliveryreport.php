...
init_cobalt('Add deliveryreport');
...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($dbh_deliveryreport->check_uniqueness($_POST)) ;
        else $message = "Record already exists with the same primary identifiers!";

        if($message=="")
        {
            $dbh_deliveryreport->add($_POST);
...
$html->draw_header('Add deliveryreport', $message, $message_type);
