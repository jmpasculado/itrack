...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_salesorder_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_salesorder->export_to_csv();
...
$html->draw_header('CSV Exporter: salesorder', $message, $message_type);
...
$html->draw_text_field('PurchaseOrder', 'PurchaseOrder', FALSE, 'text', TRUE);
