...
$html = new salesorder_html;
$html->draw_header('List View: salesorder', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add salesorder')) echo "&nbsp; &nbsp; <a href='add_salesorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View salesorder')) echo "&nbsp; &nbsp; <a href='csv_salesorder.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_salesorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit salesorder')) echo "&nbsp;&nbsp;<a href='edit_salesorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete salesorder')) echo "&nbsp;&nbsp;<a href='delete_salesorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
