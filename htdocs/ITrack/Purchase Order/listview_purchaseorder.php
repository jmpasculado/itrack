...
init_cobalt('View purchaseorder');
...
$html = new purchaseorder_html;
$html->draw_header('List View: purchaseorder', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add purchaseorder')) echo "&nbsp; &nbsp; <a href='add_purchaseorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View purchaseorder')) echo "&nbsp; &nbsp; <a href='csv_purchaseorder.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_purchaseorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit purchaseorder')) echo "&nbsp;&nbsp;<a href='edit_purchaseorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete purchaseorder')) echo "&nbsp;&nbsp;<a href='delete_purchaseorder.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
