...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_purchaseorder_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_purchaseorder->export_to_csv();
...
$html->draw_header('CSV Exporter: purchaseorder', $message, $message_type);
...
$html->draw_text_field('Customer', 'Customer', FALSE, 'text', TRUE);
$html->draw_text_field('DateOfDelivery', 'DateOfDelivery', FALSE, 'text', TRUE);
