...
if(xsrf_guard())
{
    ...
    if($_POST['submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = '/' . $_SESSION['user'] . '_inventory_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . $csv_name;
            $linkname = TMP_HYPERLINK_PATH . $csv_name;

            $csv_contents = $dbh_inventory->export_to_csv();
...
$html->draw_header('CSV Exporter: inventory', $message, $message_type);
...
$html->draw_text_field('Brand', 'Brand', FALSE, 'text', TRUE);
$html->draw_text_field('Description', 'Description', FALSE, 'text', TRUE);
$html->draw_text_field('Quantity', 'Quantity', FALSE, 'text', TRUE);
$html->draw_text_field('PerShelf', 'PerShelf', FALSE, 'text', TRUE);
$html->draw_text_field('Unit', 'Unit', FALSE, 'text', TRUE);
$html->draw_text_field('Price', 'Price', FALSE, 'text', TRUE);
