...
$html = new inventory_html;
$html->draw_header('List View: inventory', $message, $message_type);
...
<tr>
    ...
    if(check_link('Add inventory')) echo "&nbsp; &nbsp; <a href='add_inventory.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page'>Add new record</a>";
    if(check_link('View inventory')) echo "&nbsp; &nbsp; <a href='csv_inventory.php'> Export data </a>";
    ?>
    <br><br>
    </td>
</tr>
...
<?php
    if($result = $data_con->make_query())
    {
        while($row = $result->fetch_assoc())
        {
            ...
            $a++;
            extract($row);
            echo "<tr class=$class><td align='center'><a href='detailview_inventory.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/view.png' alt='View' title='View'></a>";
            if(check_link('Edit inventory')) echo "&nbsp;&nbsp;<a href='edit_inventory.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/edit.png' alt='Edit' title='Edit'></a>";
            if(check_link('Delete inventory')) echo "&nbsp;&nbsp;<a href='delete_inventory.php?filter_field_used=$enc_filter_field&filter_used=$enc_filter&page_from=$current_page&id=$id'><img src='/ITrack/images/delete.png' alt='Delete' title='Delete'></a>";
            echo '</td>';
